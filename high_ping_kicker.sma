...
public plugin_init()
{
  ...
  register_cvar("amx_hpk_ping","160")
...
public showWarn(param[])
  client_print( param[0] ,print_chat,"* Jogadores com ping maior que %d serao kicados automaticamente!", get_cvar_num( "amx_hpk_ping" ) )
...
{ 
  ...
  client_print(0,print_chat,"** O jogador %s foi desconectado automaticamente porque o ping passou de 160",name)
  server_cmd("kick #%d ^"Voce foi kicado automaticamente porque seu ping passou de 160.^"",get_user_userid(id))
