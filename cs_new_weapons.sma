...
new maxplayers
new bool:g_weapons[33] // by Wilian Maique :)

public plugin_init()
{
	register_plugin("Weapon Model + Sound Replacement",VERSION,"GHW_Chronic | Wilian Maique")
	...
	register_clcmd("say /armas", "desativar_armas")
	register_clcmd("say_team /armas", "desativar_armas")
}
